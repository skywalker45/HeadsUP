...
/**
 * Created by Blaker on 4/18/2017.
 */
...
public class CalendarActivity extends Activity
    ...
    static final String clientID = "301297885256-7lpvb5qrkq6vombdb4647vqlg9l7mp9j.apps.googleusercontent.com";
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                //go to view week for style
                Intent intent = new Intent(CalendarActivity.this, ViewWeekActivity.class);
                //and pass info
                intent.putStringArrayListExtra("list", (ArrayList<String>) output);
